    ...
    <div className="p-4 space-y-5">
      ...
      <div className="grid grid-cols-3 gap-2">
        {[
          ...
          <div key={s.label} className="bg-[#222] rounded-2xl p-3 text-center animate-fadein">
            <p className="text-2xl font-bold text-[#ff4757]">{s.value}</p>
      ...
      {/* 프로필 */}
      <div className="bg-[#222] rounded-2xl p-4 space-y-3 animate-fadein">
        ...
        <div>
          ...
          <input
            ...
            placeholder="내 이름"
            className="w-full bg-[#2a2a2a] rounded-xl px-4 py-2.5 text-sm outline-none focus:ring-1 focus:ring-[#ff4757] transition-all"
          />
        </div>
        <div>
            ...
            {GOALS.map(g => (
              <button
                ...
                className={`py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
                  goal === g.value
                    ? 'bg-[#ff4757] text-white scale-[1.02]'
        ...
        <button
          ...
          className={`w-full py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${
            saved ? 'bg-emerald-600' : 'bg-[#ff4757] hover:bg-[#ff6b6b]'
          }`}
        >
          {saved ? '저장됨 ✓' : '저장'}
        </button>
      ...
      {/* 종목 관리 */}
      <div className="bg-[#222] rounded-2xl overflow-hidden animate-fadein">
        <button
      ...
      {/* 데이터 관리 */}
      <div className="bg-[#222] rounded-2xl p-4 space-y-2 animate-fadein">
