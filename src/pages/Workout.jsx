    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between pt-4">
        ...
        <button
          onClick={finish}
          disabled={saving}
          className="bg-[#ff4757] hover:bg-[#ff6b6b] disabled:opacity-50 px-4 py-2 rounded-xl text-sm font-medium"
        >
          완료
        </button>
      </div>
      ...
      <div className="space-y-3">
        {exercises.map((ex, exIdx) => (
          <div key={exIdx} className="bg-[#222] rounded-2xl p-4 space-y-3">
            ...
            {ex.sets.map((s, setIdx) => (
              <div key={setIdx} className={`grid grid-cols-12 gap-1 items-center rounded-xl px-1 py-1 transition-opacity ${s.done ? 'opacity-40' : ''}`}>
                ...
                <input
                  ...
                  className="col-span-5 bg-[#2a2a2a] rounded-lg text-center text-sm py-1.5 w-full outline-none focus:ring-1 focus:ring-[#ff4757]"
                />
                <input
                  type="number"
                  inputMode="numeric"
                  ...
                  className="col-span-4 bg-[#2a2a2a] rounded-lg text-center text-sm py-1.5 w-full outline-none focus:ring-1 focus:ring-[#ff4757]"
                />
                <button
            ...
            <button
              ...
              className="w-full py-1.5 rounded-xl bg-[#2a2a2a] hover:bg-[#333] text-sm text-slate-400 transition-colors"
            >
              + 세트 추가
            </button>
          </div>
